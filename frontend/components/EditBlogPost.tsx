      ...
      <>
        <div className="flex h-full overflow-x-hidden">
          ...
          <div className="p-8 w-1/2 relative">
            ...
            <button
              onClick={handlePost}
              className={`fixed btn btn-primary mr-10 mb-4 right-0 bottom-0 ${(markdown.length < 500 || markdown.length > 20000 || !title) &&
                "btn-disabled"
                }`}>
              Save
            </button>
            ...
            <button
              ...
              className={`fixed btn btn-error mr-32 mb-4 right-0 bottom-0`}>
              Delete
            </button>
...
| Paragraph   | Text        | `}
      ...
      <h2>Conclusion</h2>
      <p>
        This cheat sheet provides a quick reference to common Markdown syntax
        and formatting options. By familiarizing yourself with these elements,
        you can quickly and effectively create structured and formatted
        documents using Markdown.
      </p>
    </div>
  );
};
